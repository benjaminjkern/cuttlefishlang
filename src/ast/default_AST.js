module.exports = (macroContext) => {
    ...
    return {
        ...
        Statement_print(_1, exp) {
            return line_number(node("PrintStatement", exp.ast()), this.source);
        },
        Statement_put(_1, exp) {
            return line_number(node("PutStatement", exp.ast()), this.source);
        },
        Block_small(list, _1, _2) {
            return list.ast();
        },
        ...
        Pattern(list) {
            return line_number(node("Pattern", list.ast()), this.source);
        },
        ...
        PatternElement_typed(type, _1, id) {
            return line_number(
                node("TypePattern", type.ast(), id.ast()),
                this.source
            );
        },
        PatternElement_atomic(atom) {
            return line_number(node("AtomicPattern", atom.ast()), this.source);
        },
        Type(id) {
            return line_number(node("Type", id.ast()), this.source);
        },
        Type_tuple(_1, block, _2) {
            return line_number(node("TupleType", block.ast()), this.source);
        },
        ...
        Type_list(list_type) {
            return list_type.ast();
        },
        ListType(_1, type, _2) {
            return line_number(node("ListType", type.ast()), this.source);
        },
        ...
        SubRoutineGroup_singular(stmtblock) {
            return line_number(
                node("AnonymousSubRoutineGroup", stmtblock.ast()),
                this.source
            );
        },
        Routine(subroutine) {
            return subroutine.ast();
        },
        Function(_1, _2, subroutine_group) {
            return line_number(node("Function", subroutine_group.ast()), this.source);
        },
        Process(_1, _2, subroutine_group) {
            return line_number(node("Process", subroutine_group.ast()), this.source);
        },
        Server(_1, _2, subroutine_group) {
            return line_number(node("Server", subroutine_group.ast()), this.source);
        },
        SubRoutine(pattern, _1, guard, _2, returnTypes, _3, _4, block) {
            return line_number(
                node(
                    "SubRoutine",
                    pattern.ast(),
        ...
        Expression(atom_list) {
            return line_number(node("Expression", atom_list.ast()), this.source);
        },
        Atom(contents) {
            return contents.ast();
        },
        ...
        Select(object, selector) {
            return line_number(
                node("Select", object.ast(), selector.ast()),
                this.source
            );
        },
        Selector(list) {
        ...
        Selector_nonSlice(_1, selectOp, _2) {
            return selectOp.ast();
        },
        Tuple_nonempty(_1, block, _2) {
            return line_number(node("Tuple", block.ast()), this.source);
        },
        Tuple_empty(_1, _2) {
            return line_number(node("Tuple", []), this.source);
        },
        ...
        List_nonempty(_1, seq, _2) {
            return line_number(node("List", seq.ast()), this.source);
        },
        List_empty(_1, _2) {
            return line_number(node("List", []), this.source);
        },
        index(content) {
            return content.ast();
        },
        String(seq) {
            return line_number(node("String", this.sourceString), this.source);
        },
        ...
        id(contents) {
            return line_number(node("Id", this.sourceString), this.source);
        },
        NonemptyListOf(head, sep, tail) {
            return [head, tail].map((x) => x.ast());
        },
        nospaceops(op) {
            return line_number(node("Operator", this.sourceString), this.source);
        },
    };
};